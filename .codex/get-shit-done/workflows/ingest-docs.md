...
```bash
INIT=$(node "C:/Users/duyma/Desktop/loex/.codex/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "C:/Users/duyma/Desktop/loex/.codex/get-shit-done/bin/gsd-tools.cjs" commit \

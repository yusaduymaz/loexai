...
```bash
INIT=$(node "C:/Users/duyma/Desktop/loex/.codex/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/Users/duyma/Desktop/loex/.codex/get-shit-done/templates/spec.md.
